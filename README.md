...
The following environment variables allow the plugin to assume a specified AWS IAM rolewhen using IRSA, using credentials and an ExternalID if required by the role’s trust policy.
