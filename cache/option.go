...
// WithRestoreNonExistentKeyErr sets option to fail restore if key does not exist.
func WithRestoreNonExistentKeyErr(restoreNonExistentKeyErr bool) Option {
	return optionFunc(func(o *options) {
		o.restoreNonExistentKeyErr = restoreNonExistentKeyErr
	})
}
